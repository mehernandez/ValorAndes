...
<%ResultSet t1 =(ResultSet)(request.getAttribute("t1"));
ResultSet t2 =(ResultSet)(request.getAttribute("t2"));
ArrayList intermediarios =(ArrayList)(request.getSession().getAttribute("intermediarios"));
%>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<h1>Aqui estan Los Valores que se encuentran en venta</h1>
				<div class="col-lg-6">
					...
					<div class="table-responsive">
						<table class="table table-hover table-striped">
							...
							<tr>
								<td><%=t1.getInt("idvalor")%></td>
								<td><%=t1.getString("nombre")%></td>
								<td><%=t1.getString("tiporentabilidad")%></td>
								<td><%=t1.getString("tipovalor")%></td>
								<td><%=t1.getDouble("precio")%></td>
								<td><%=t1.getInt("cantidad")%></td>
...
<br>
<br>
<h1>Ahora puedes escoger alguno y comprarlo con su id y las
	unidades o dinero a gastar:</h1>
<br>
<form action="Comprar.html" method="post">
	<div class="form-group input-group">
		...
		<h3>O Por Dinero</h3>
		<input type="text" class="form-control" name="precio" placeholder="$$$$$"> <br> 
