...
<% ArrayList<String> porcentajes=(ArrayList)(request.getAttribute("porcentajes")); %>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Despliegue de Portafolio <small> <%=login %> </small>
                        </h1>
                 ...
                 <form action="PortafolioProcesar.html" method="POST" >
                            <div class="form-group input-group">
               				 ...
               				 <input type="text" name="transaccion" placeholder="id:cantidadNueva"></input>
                ...
                <% } else { %>
                <h4>No hay portafolio para mostrar</h4>
                <% } %>
