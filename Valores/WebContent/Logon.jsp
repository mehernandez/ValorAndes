    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>  <c:out value="${usuario}" />  <b class="caret"></b></a>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Bienvenido <c:out value="${usuario}" /> ! <small>Tu clave es <c:out value="${clave}" /> </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Log
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <form action="Logear.html" method="get" >
                            <div class="form-group input-group">
                            	<h1> Usuario : </h1><br>
                                <input type="text" class="form-control" name="usuario">  <br> <br>
                                <h1> Clave : </h1><br>
                                <input type="text" class="form-control" name="texto">  <br> <br>
