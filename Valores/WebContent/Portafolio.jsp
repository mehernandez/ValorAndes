...
ResultSet tabla2 = (ResultSet)(request.getAttribute("tabla2"));
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							Portafolio de Usuario: <small> <%=login %>
							</small>
						</h1>
				...
				<form action="PortafolioProcesar.html" method="POST">
					<div class="form-group input-group">


						<input type="text" name="transaccion"
							placeholder="id:cantidadNueva"></input> <br>
						<br>

						<button type="submit" class="btn btn-primary  btn-lg">Reorganizar</button>

					</div>
				</form>

				<h4>Portafolio Local</h4>
				...
				<form action="Preguntar.html" method="GET">
					<div class="form-group input-group">
						...
						<table class="table table-hover table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><%=tabla2.getString("idvalor") %></td>
									<td><%=tabla2.getString("nombre") %></td>
									<td><%=tabla2.getString("cantidad") %></td>
