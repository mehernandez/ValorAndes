...
<% if(tipo1.equals("intermediario")){ %>
                <h2> Intermediarios </h2>
<% }else if(tipo1.equals("oferente")){ %>
				<h2> Oferentes </h2>
<% }else if(tipo1.equals("inversionista")){%>
          		...
          		<table class="table table-hover table-striped">
          			...
          			<tbody>
						...
						<tr>
							...
							<td><a href="MostrarMiembro.html?idM="<%=result.getString("id")%>><%=result.getString("nombre") %></a></td>							
